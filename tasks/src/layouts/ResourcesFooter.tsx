...
export const ResourcesFooter = () => {
  return (
    <div className="w-screen overflow-hidden h-[73px] pl-[151px] pb-0.5 bg-[#303030] flex items-center justify-between text-white text-[11.75px] pr-[169.5px] tracking-wider font-extralight">
      <img
