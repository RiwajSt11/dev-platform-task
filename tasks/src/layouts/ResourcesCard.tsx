...
export const ResourcesCard = ({
  ...
  return (
    <div className="rounded-xl w-full md:w-100 h-98 md:h-108.75 px-7.25 py-4.25 flex flex-col items-center shadow-[0px_0px_10px_rgba(0,0,0,0.28)] group cursor-pointer">
      <div className="relative h-37 md:h-52 w-full md:w-89 rounded-lg overflow-hidden">
        <img
          src={image}
          alt="image"
          className="w-full transition-transform duration-500 ease-in-out group-hover:scale-120"
        />
        <div
